          ...
          <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-8 md:p-12 border border-white/20 shadow-2xl">
            <div className="prose prose-invert max-w-none">
              <div className="space-y-8 text-white/80">
                ...
                <section>
                  <h2 className="text-2xl font-bold text-white mb-4">4. Subscriptions, Payments & Refunds</h2>
                  <p className="leading-relaxed mb-3">
                ...
                <section>
                  <h2 className="text-2xl font-bold text-white mb-4">5. Data & Privacy</h2>
                  <p className="leading-relaxed">
                ...
                <section>
                  <h2 className="text-2xl font-bold text-white mb-4">10. Governing Law & Dispute Resolution</h2>
                  <p className="leading-relaxed">
