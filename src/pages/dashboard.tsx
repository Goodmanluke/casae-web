            ...
            <div className="bg-white/10 backdrop-blur-xl rounded-3xl p-8 border border-white/20 shadow-2xl">
              ...
              <div className="grid gap-6 md:grid-cols-3 max-w-6xl mx-auto">
                <button
                  ...
                  className="group bg-gradient-to-r from-cyan-500/20 to-blue-600/20 hover:from-cyan-500/30 hover:to-blue-600/30 backdrop-blur-sm rounded-2xl p-8 border border-cyan-400/30 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl text-left"
                >
                ...
                <button
                  ...
                  className="group bg-gradient-to-r from-purple-500/20 to-pink-600/20 hover:from-purple-500/30 hover:to-pink-600/30 backdrop-blur-sm rounded-2xl p-8 border border-purple-400/30 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl text-left"
                >
                  <div className="flex items-center gap-6">
                ...
                <button
                  onClick={handleSubscribe}
                  className="group bg-gradient-to-r from-emerald-500/20 to-teal-600/20 hover:from-emerald-500/30 hover:to-teal-600/30 backdrop-blur-sm rounded-2xl p-8 border border-emerald-400/30 transition-all duration-300 transform hover:scale-105 hover:shadow-2xl text-left"
                >
                  <div className="flex items-center gap-6">
