  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center py-8 px-4 bg-gray-50">
      ...
      <p className="text-lg text-gray-700 mb-4 text-center max-w-xl">
        Enter any address (for now, it won\'t be sent anywhere). When you submit, we\'ll call the backend API and display the health status.
      </p>
      ...
      {response && (
        <pre className="mt-4 bg-gray-200 p-2 rounded w-full max-w-md overflow-auto">
